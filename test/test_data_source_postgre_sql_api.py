...
class TestDataSourcePostgreSqlApi(unittest.TestCase):
    ...
    def test_data_source_postgre_sqls_patch(self):
        """
        Test case for data_source_postgre_sqls_patch
    ...
    def test_data_source_postgre_sqls_put(self):
        """
        Test case for data_source_postgre_sqls_put

        Replace an existing model instance or insert a new one into the data source.
        """
        pass

    def test_data_source_postgre_sqls_replace_or_create_post(self):
        """
        Test case for data_source_postgre_sqls_replace_or_create_post

        Replace an existing model instance or insert a new one into the data source.
        """
        pass

    def test_data_source_postgre_sqls_update_post(self):
        """
        Test case for data_source_postgre_sqls_update_post

        Update instances of the model matched by {{where}} from the data source.
        """
        pass

    def test_data_source_postgre_sqls_upsert_with_where_post(self):
        """
        Test case for data_source_postgre_sqls_upsert_with_where_post
