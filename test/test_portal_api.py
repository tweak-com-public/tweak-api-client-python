...
class TestPortalApi(unittest.TestCase):
    ...
    def test_portals_id_builder_config_default_get(self):
        """
        Test case for portals_id_builder_config_default_get

        Get default TeamBuilderConfig for this Portal
        """
        pass

    def test_portals_id_default_builder_config_get(self):
        """
        Test case for portals_id_default_builder_config_get
