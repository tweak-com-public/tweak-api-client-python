...
class InvitationTicketApi(object):
    ...
    def invitation_tickets_id_target_design_get(self, id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.invitation_tickets_id_target_design_get_with_http_info(id, **kwargs)
        else:
            (data) = self.invitation_tickets_id_target_design_get_with_http_info(id, **kwargs)
            return data
    ...
    def invitation_tickets_id_target_design_get_with_http_info(self, id, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method invitation_tickets_id_target_design_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `invitation_tickets_id_target_design_get`")


        collection_formats = {}

        resource_path = '/InvitationTickets/{id}/targetDesign'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def invitation_tickets_id_target_design_member_get(self, id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.invitation_tickets_id_target_design_member_get_with_http_info(id, **kwargs)
        else:
            (data) = self.invitation_tickets_id_target_design_member_get_with_http_info(id, **kwargs)
            return data
    ...
    def invitation_tickets_id_target_design_member_get_with_http_info(self, id, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method invitation_tickets_id_target_design_member_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `invitation_tickets_id_target_design_member_get`")


        collection_formats = {}

        resource_path = '/InvitationTickets/{id}/targetDesignMember'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
