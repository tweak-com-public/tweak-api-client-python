...
class PortalTemplateFolderApi(object):
    ...
    def portal_template_folders_id_children_delete(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.portal_template_folders_id_children_delete(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.portal_template_folders_id_children_delete_with_http_info(id, **kwargs)
        else:
            (data) = self.portal_template_folders_id_children_delete_with_http_info(id, **kwargs)
            return data

    def portal_template_folders_id_children_delete_with_http_info(self, id, **kwargs):
        """
        Deletes all children of this model.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.portal_template_folders_id_children_delete_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method portal_template_folders_id_children_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `portal_template_folders_id_children_delete`")
    ...
    def portal_template_folders_id_templates_delete(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.portal_template_folders_id_templates_delete(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.portal_template_folders_id_templates_delete_with_http_info(id, **kwargs)
        else:
            (data) = self.portal_template_folders_id_templates_delete_with_http_info(id, **kwargs)
            return data

    def portal_template_folders_id_templates_delete_with_http_info(self, id, **kwargs):
        """
        Deletes all templates of this model.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.portal_template_folders_id_templates_delete_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method portal_template_folders_id_templates_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `portal_template_folders_id_templates_delete`")
    ...
    def portal_template_folders_patch(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.portal_template_folders_patch(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.portal_template_folders_patch_with_http_info(**kwargs)
        else:
            (data) = self.portal_template_folders_patch_with_http_info(**kwargs)
            return data

    def portal_template_folders_patch_with_http_info(self, **kwargs):
        """
        Patch an existing model instance or insert a new one into the data source.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.portal_template_folders_patch_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method portal_template_folders_patch" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def portal_template_folders_put(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.portal_template_folders_put(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.portal_template_folders_put_with_http_info(**kwargs)
        else:
            (data) = self.portal_template_folders_put_with_http_info(**kwargs)
            return data

    def portal_template_folders_put_with_http_info(self, **kwargs):
        """
        Replace an existing model instance or insert a new one into the data source.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.portal_template_folders_put_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method portal_template_folders_put" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def portal_template_folders_replace_or_create_post(self, **kwargs):
        """
        Replace an existing model instance or insert a new one into the data source.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.portal_template_folders_replace_or_create_post(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.portal_template_folders_replace_or_create_post_with_http_info(**kwargs)
        else:
            (data) = self.portal_template_folders_replace_or_create_post_with_http_info(**kwargs)
            return data

    def portal_template_folders_replace_or_create_post_with_http_info(self, **kwargs):
        """
        Replace an existing model instance or insert a new one into the data source.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.portal_template_folders_replace_or_create_post_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method portal_template_folders_replace_or_create_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/PortalTemplateFolders/replaceOrCreate'.replace('{format}', 'json')
        path_params = {}
    ...
    def portal_template_folders_update_post(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.portal_template_folders_update_post(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.portal_template_folders_update_post_with_http_info(**kwargs)
        else:
            (data) = self.portal_template_folders_update_post_with_http_info(**kwargs)
            return data

    def portal_template_folders_update_post_with_http_info(self, **kwargs):
        """
        Update instances of the model matched by {{where}} from the data source.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.portal_template_folders_update_post_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method portal_template_folders_update_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/PortalTemplateFolders/update'.replace('{format}', 'json')
        path_params = {}
    ...
    def portal_template_folders_upsert_with_where_post(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.portal_template_folders_upsert_with_where_post(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.portal_template_folders_upsert_with_where_post_with_http_info(**kwargs)
        else:
            (data) = self.portal_template_folders_upsert_with_where_post_with_http_info(**kwargs)
            return data

    def portal_template_folders_upsert_with_where_post_with_http_info(self, **kwargs):
        """
        Update an existing model instance or insert a new one into the data source based on the where criteria.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.portal_template_folders_upsert_with_where_post_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method portal_template_folders_upsert_with_where_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/PortalTemplateFolders/upsertWithWhere'.replace('{format}', 'json')
        path_params = {}
