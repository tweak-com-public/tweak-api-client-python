...
class PortalApi(object):
    ...
    def portals_id_designs_nk_customer_get(self, id, nk, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.portals_id_designs_nk_customer_get(id, nk, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.portals_id_designs_nk_customer_get_with_http_info(id, nk, **kwargs)
        else:
            (data) = self.portals_id_designs_nk_customer_get_with_http_info(id, nk, **kwargs)
            return data

    def portals_id_designs_nk_customer_get_with_http_info(self, id, nk, **kwargs):
        """
        Fetches belongsTo relation customer.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.portals_id_designs_nk_customer_get_with_http_info(id, nk, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method portals_id_designs_nk_customer_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `portals_id_designs_nk_customer_get`")
        # verify the required parameter 'nk' is set
        if ('nk' not in params) or (params['nk'] is None):
            raise ValueError("Missing the required parameter `nk` when calling `portals_id_designs_nk_customer_get`")


        collection_formats = {}

        resource_path = '/Portals/{id}/designs/{nk}/customer'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
        if 'nk' in params:
