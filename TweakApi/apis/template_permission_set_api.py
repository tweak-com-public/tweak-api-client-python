...
class TemplatePermissionSetApi(object):
    ...
    def template_permission_sets_patch(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.template_permission_sets_patch(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.template_permission_sets_patch_with_http_info(**kwargs)
        else:
            (data) = self.template_permission_sets_patch_with_http_info(**kwargs)
            return data

    def template_permission_sets_patch_with_http_info(self, **kwargs):
        """
        Patch an existing model instance or insert a new one into the data source.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.template_permission_sets_patch_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method template_permission_sets_patch" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def template_permission_sets_put(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.template_permission_sets_put(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.template_permission_sets_put_with_http_info(**kwargs)
        else:
            (data) = self.template_permission_sets_put_with_http_info(**kwargs)
            return data

    def template_permission_sets_put_with_http_info(self, **kwargs):
        """
        Replace an existing model instance or insert a new one into the data source.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.template_permission_sets_put_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method template_permission_sets_put" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def template_permission_sets_replace_or_create_post(self, **kwargs):
        """
        Replace an existing model instance or insert a new one into the data source.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.template_permission_sets_replace_or_create_post(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.template_permission_sets_replace_or_create_post_with_http_info(**kwargs)
        else:
            (data) = self.template_permission_sets_replace_or_create_post_with_http_info(**kwargs)
            return data

    def template_permission_sets_replace_or_create_post_with_http_info(self, **kwargs):
        """
        Replace an existing model instance or insert a new one into the data source.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.template_permission_sets_replace_or_create_post_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method template_permission_sets_replace_or_create_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/TemplatePermissionSets/replaceOrCreate'.replace('{format}', 'json')
        path_params = {}
    ...
    def template_permission_sets_update_post(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.template_permission_sets_update_post(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.template_permission_sets_update_post_with_http_info(**kwargs)
        else:
            (data) = self.template_permission_sets_update_post_with_http_info(**kwargs)
            return data

    def template_permission_sets_update_post_with_http_info(self, **kwargs):
        """
        Update instances of the model matched by {{where}} from the data source.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.template_permission_sets_update_post_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method template_permission_sets_update_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/TemplatePermissionSets/update'.replace('{format}', 'json')
        path_params = {}
    ...
    def template_permission_sets_upsert_with_where_post(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.template_permission_sets_upsert_with_where_post(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.template_permission_sets_upsert_with_where_post_with_http_info(**kwargs)
        else:
            (data) = self.template_permission_sets_upsert_with_where_post_with_http_info(**kwargs)
            return data

    def template_permission_sets_upsert_with_where_post_with_http_info(self, **kwargs):
        """
        Update an existing model instance or insert a new one into the data source based on the where criteria.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.template_permission_sets_upsert_with_where_post_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method template_permission_sets_upsert_with_where_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/TemplatePermissionSets/upsertWithWhere'.replace('{format}', 'json')
        path_params = {}
