...
class ProductTypeApi(object):
    ...
    def product_types_id_sizes_delete(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.product_types_id_sizes_delete(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.product_types_id_sizes_delete_with_http_info(id, **kwargs)
        else:
            (data) = self.product_types_id_sizes_delete_with_http_info(id, **kwargs)
            return data

    def product_types_id_sizes_delete_with_http_info(self, id, **kwargs):
        """
        Deletes all sizes of this model.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.product_types_id_sizes_delete_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method product_types_id_sizes_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `product_types_id_sizes_delete`")
    ...
    def product_types_patch(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.product_types_patch(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.product_types_patch_with_http_info(**kwargs)
        else:
            (data) = self.product_types_patch_with_http_info(**kwargs)
            return data

    def product_types_patch_with_http_info(self, **kwargs):
        """
        Patch an existing model instance or insert a new one into the data source.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.product_types_patch_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method product_types_patch" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def product_types_put(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.product_types_put(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.product_types_put_with_http_info(**kwargs)
        else:
            (data) = self.product_types_put_with_http_info(**kwargs)
            return data

    def product_types_put_with_http_info(self, **kwargs):
        """
        Replace an existing model instance or insert a new one into the data source.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.product_types_put_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method product_types_put" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def product_types_replace_or_create_post(self, **kwargs):
        """
        Replace an existing model instance or insert a new one into the data source.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.product_types_replace_or_create_post(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.product_types_replace_or_create_post_with_http_info(**kwargs)
        else:
            (data) = self.product_types_replace_or_create_post_with_http_info(**kwargs)
            return data

    def product_types_replace_or_create_post_with_http_info(self, **kwargs):
        """
        Replace an existing model instance or insert a new one into the data source.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.product_types_replace_or_create_post_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method product_types_replace_or_create_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/ProductTypes/replaceOrCreate'.replace('{format}', 'json')
        path_params = {}
    ...
    def product_types_update_post(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.product_types_update_post(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.product_types_update_post_with_http_info(**kwargs)
        else:
            (data) = self.product_types_update_post_with_http_info(**kwargs)
            return data

    def product_types_update_post_with_http_info(self, **kwargs):
        """
        Update instances of the model matched by {{where}} from the data source.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.product_types_update_post_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method product_types_update_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/ProductTypes/update'.replace('{format}', 'json')
        path_params = {}
    ...
    def product_types_upsert_with_where_post(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.product_types_upsert_with_where_post(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.product_types_upsert_with_where_post_with_http_info(**kwargs)
        else:
            (data) = self.product_types_upsert_with_where_post_with_http_info(**kwargs)
            return data

    def product_types_upsert_with_where_post_with_http_info(self, **kwargs):
        """
        Update an existing model instance or insert a new one into the data source based on the where criteria.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.product_types_upsert_with_where_post_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method product_types_upsert_with_where_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/ProductTypes/upsertWithWhere'.replace('{format}', 'json')
        path_params = {}
