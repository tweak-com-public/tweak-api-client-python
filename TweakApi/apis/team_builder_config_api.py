...
class TeamBuilderConfigApi(object):
    ...
    def team_builder_configs_global_get(self, **kwargs):
        """
        Reset Team keys
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_global_get(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.team_builder_configs_global_get_with_http_info(**kwargs)
        else:
            (data) = self.team_builder_configs_global_get_with_http_info(**kwargs)
            return data

    def team_builder_configs_global_get_with_http_info(self, **kwargs):
        """
        Reset Team keys
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_global_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method team_builder_configs_global_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/TeamBuilderConfigs/global'.replace('{format}', 'json')
        path_params = {}
