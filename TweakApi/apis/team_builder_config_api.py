...
class TeamBuilderConfigApi(object):
    ...
    def team_builder_configs_id_global_get(self, id, **kwargs):
        """
        Reset Team keys
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_id_global_get(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.team_builder_configs_id_global_get_with_http_info(id, **kwargs)
        else:
            (data) = self.team_builder_configs_id_global_get_with_http_info(id, **kwargs)
            return data

    def team_builder_configs_id_global_get_with_http_info(self, id, **kwargs):
        """
        Reset Team keys
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_id_global_get_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method team_builder_configs_id_global_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `team_builder_configs_id_global_get`")


        collection_formats = {}

        resource_path = '/TeamBuilderConfigs/{id}/global'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def team_builder_configs_id_portals_count_get(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_id_portals_count_get(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.team_builder_configs_id_portals_count_get_with_http_info(id, **kwargs)
        else:
            (data) = self.team_builder_configs_id_portals_count_get_with_http_info(id, **kwargs)
            return data

    def team_builder_configs_id_portals_count_get_with_http_info(self, id, **kwargs):
        """
        Counts portals of TeamBuilderConfig.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_id_portals_count_get_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method team_builder_configs_id_portals_count_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `team_builder_configs_id_portals_count_get`")


        collection_formats = {}

        resource_path = '/TeamBuilderConfigs/{id}/portals/count'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def team_builder_configs_id_portals_delete(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_id_portals_delete(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.team_builder_configs_id_portals_delete_with_http_info(id, **kwargs)
        else:
            (data) = self.team_builder_configs_id_portals_delete_with_http_info(id, **kwargs)
            return data

    def team_builder_configs_id_portals_delete_with_http_info(self, id, **kwargs):
        """
        Deletes all portals of this model.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_id_portals_delete_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method team_builder_configs_id_portals_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `team_builder_configs_id_portals_delete`")


        collection_formats = {}

        resource_path = '/TeamBuilderConfigs/{id}/portals'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def team_builder_configs_id_portals_fk_delete(self, id, fk, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_id_portals_fk_delete(id, fk, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.team_builder_configs_id_portals_fk_delete_with_http_info(id, fk, **kwargs)
        else:
            (data) = self.team_builder_configs_id_portals_fk_delete_with_http_info(id, fk, **kwargs)
            return data

    def team_builder_configs_id_portals_fk_delete_with_http_info(self, id, fk, **kwargs):
        """
        Delete a related item by id for portals.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_id_portals_fk_delete_with_http_info(id, fk, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method team_builder_configs_id_portals_fk_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `team_builder_configs_id_portals_fk_delete`")
        # verify the required parameter 'fk' is set
        if ('fk' not in params) or (params['fk'] is None):
            raise ValueError("Missing the required parameter `fk` when calling `team_builder_configs_id_portals_fk_delete`")


        collection_formats = {}

        resource_path = '/TeamBuilderConfigs/{id}/portals/{fk}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
        if 'fk' in params:
    ...
    def team_builder_configs_id_portals_fk_get(self, id, fk, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_id_portals_fk_get(id, fk, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.team_builder_configs_id_portals_fk_get_with_http_info(id, fk, **kwargs)
        else:
            (data) = self.team_builder_configs_id_portals_fk_get_with_http_info(id, fk, **kwargs)
            return data

    def team_builder_configs_id_portals_fk_get_with_http_info(self, id, fk, **kwargs):
        """
        Find a related item by id for portals.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_id_portals_fk_get_with_http_info(id, fk, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method team_builder_configs_id_portals_fk_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `team_builder_configs_id_portals_fk_get`")
        # verify the required parameter 'fk' is set
        if ('fk' not in params) or (params['fk'] is None):
            raise ValueError("Missing the required parameter `fk` when calling `team_builder_configs_id_portals_fk_get`")
    ...
    def team_builder_configs_id_portals_fk_put(self, id, fk, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_id_portals_fk_put(id, fk, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.team_builder_configs_id_portals_fk_put_with_http_info(id, fk, **kwargs)
        else:
            (data) = self.team_builder_configs_id_portals_fk_put_with_http_info(id, fk, **kwargs)
            return data

    def team_builder_configs_id_portals_fk_put_with_http_info(self, id, fk, **kwargs):
        """
        Update a related item by id for portals.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_id_portals_fk_put_with_http_info(id, fk, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method team_builder_configs_id_portals_fk_put" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `team_builder_configs_id_portals_fk_put`")
        # verify the required parameter 'fk' is set
        if ('fk' not in params) or (params['fk'] is None):
            raise ValueError("Missing the required parameter `fk` when calling `team_builder_configs_id_portals_fk_put`")
    ...
    def team_builder_configs_id_portals_get(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_id_portals_get(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.team_builder_configs_id_portals_get_with_http_info(id, **kwargs)
        else:
            (data) = self.team_builder_configs_id_portals_get_with_http_info(id, **kwargs)
            return data

    def team_builder_configs_id_portals_get_with_http_info(self, id, **kwargs):
        """
        Queries portals of TeamBuilderConfig.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_id_portals_get_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method team_builder_configs_id_portals_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `team_builder_configs_id_portals_get`")
    ...
    def team_builder_configs_id_portals_post(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_id_portals_post(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.team_builder_configs_id_portals_post_with_http_info(id, **kwargs)
        else:
            (data) = self.team_builder_configs_id_portals_post_with_http_info(id, **kwargs)
            return data

    def team_builder_configs_id_portals_post_with_http_info(self, id, **kwargs):
        """
        Creates a new instance in portals of this model.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.team_builder_configs_id_portals_post_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method team_builder_configs_id_portals_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `team_builder_configs_id_portals_post`")
