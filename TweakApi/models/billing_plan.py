...
class BillingPlan(object):
    ...
    """
    def __init__(self, id=None, name=None, amount=None, currency=None, interval=None, interval_count=None, statement_descriptor=None, statement_description=None, trial_period_days=None, type=None, created=None):
        """
