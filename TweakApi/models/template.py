...
class Template(object):
    ...
    """
    def __init__(self, name=None, thumbnail=None, object=None, description='', edited=None, team_path='/', status=None, created=None, modified=None, id=None, team_id=None, uploader_id=None, team_folder_id=None, workflow_id=None, portals=None, team=None, members=None, template_members=None, permission=None, designs=None, tags=None, team_folder=None, portal_folders=None, workflow=None, uploader=None):
        """
