...
class TeamBuilderConfigProductSizeMaterial(object):
    ...
    """
    def __init__(self, binding_type=None, default_bleed=None, created=None, modified=None, id=None, product_size_material_id=None, builder_config_id=None, builder_config=None, product_size_material=None):
        """
