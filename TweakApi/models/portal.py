...
class Portal(object):
    ...
    """
    def __init__(self, name=None, logo=None, status='private', language='en', created=None, modified=None, id=None, team_id=None, templates=None, template_rels=None, members=None, portal_members=None, team=None, designs=None, template_folders=None, design_folders=None, image_folders=None):
        """
