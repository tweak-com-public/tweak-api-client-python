...
class Portal(object):
    ...
    """
    def __init__(self, name=None, logo=None, status=None, language=None, created=None, modified=None, id=None, team_id=None, default_builder_config_id=None, default_builder_config=None, templates=None, template_rels=None, members=None, portal_members=None, team=None, designs=None, template_folders=None, design_folders=None, image_folders=None, permission=None):
        """
        ...
        self.swagger_types = {
            ...
            'id': 'str',
            'team_id': 'str',
            'default_builder_config_id': 'str',
            'default_builder_config': 'TeamBuilderConfig',
        ...
        self.attribute_map = {
            ...
            'id': 'id',
            'team_id': 'teamId',
            'default_builder_config_id': 'defaultBuilderConfigId',
            'default_builder_config': 'defaultBuilderConfig',
            'templates': 'templates',
        ...
        self._default_builder_config_id = default_builder_config_id
        self._default_builder_config = default_builder_config
    ...
    @property
    def default_builder_config_id(self):
        """
        Gets the default_builder_config_id of this Portal.


        :return: The default_builder_config_id of this Portal.
        :rtype: str
        """
        return self._default_builder_config_id

    @default_builder_config_id.setter
    def default_builder_config_id(self, default_builder_config_id):
        """
        Sets the default_builder_config_id of this Portal.


        :param default_builder_config_id: The default_builder_config_id of this Portal.
        :type: str
        """
    ...
    @property
    def default_builder_config(self):
        """
        Gets the default_builder_config of this Portal.


        :return: The default_builder_config of this Portal.
        :rtype: TeamBuilderConfig
        """
        return self._default_builder_config

    @default_builder_config.setter
    def default_builder_config(self, default_builder_config):
        """
        Sets the default_builder_config of this Portal.


        :param default_builder_config: The default_builder_config of this Portal.
