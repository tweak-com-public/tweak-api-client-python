...
class DesignFolder(object):
    ...
    """
    def __init__(self, name=None, path='/', created=None, modified=None, id=None, member_id=None, parent_id=None, portal_id=None, member=None, children=None, parent=None, designs=None, portal=None):
        """
