...
class Design(object):
    ...
    """
    def __init__(self, colors=None, image=None, name=None, object=None, thumbnail=None, description='', purpose=None, status=None, form_data=None, high_res_pdf_url='', proof_pdf_url='', jpegs_url='', edited=None, expired=None, path='/', sent_for_approval=None, approved=None, shared=None, created=None, modified=None, id=None, dynamic_data_id=None, requester_id=None, assignee_id=None, reviewer_id=None, template_id=None, portal_id=None, rejection_comment_id=None, folder_id=None, tags=None, template=None, portal=None, comments=None, rejection_comment=None, exports=None, requester=None, assignee=None, reviewer=None, commenters=None, folder=None, permission=None, members=None, design_members=None, dynamic_data=None):
        """
