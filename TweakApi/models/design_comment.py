...
class DesignComment(object):
    ...
    """
    def __init__(self, comment=None, position=None, page_index=0.0, status='unsolved', created=None, modified=None, id=None, design_id=None, comment_id=None, commenter_id=None, design=None, replies=None, commenter=None, reply_of=None):
        """
