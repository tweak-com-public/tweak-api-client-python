...
class Team(object):
    ...
    """
    def __init__(self, name=None, is_legacy_partner=False, logo=None, subdomain=None, country='Ireland', created=None, modified=None, id=None, icon=None, client_key=None, java_script_key=None, rest_api_key=None, windows_key=None, master_key=None, status='sandbox', team_data_id=None, members=None, builder_configs=None, dynamic_datas=None, data_source_soaps=None, team_members=None, portals=None, templates=None, brand=None, template_folders=None, workflows=None, images=None, image_folders=None, billing=None, permission=None, product_materials=None, product_size_materials=None, product_pdf_color_profiles=None, team_data=None):
        """
        ...
        self.swagger_types = {
            ...
            'data_source_soaps': 'list[DataSourceSoap]',
        ...
        self.attribute_map = {
            'name': 'name',
            'is_legacy_partner': 'isLegacyPartner',
            'logo': 'logo',
            'subdomain': 'subdomain',
            'country': 'country',
            'created': 'created',
            ...
            'data_source_soaps': 'dataSourceSoaps',
        ...
        self._name = name
        self._is_legacy_partner = is_legacy_partner
        self._logo = logo
        ...
        self._data_source_soaps = data_source_soaps
    ...
    @property
    def is_legacy_partner(self):
        """
        Gets the is_legacy_partner of this Team.


        :return: The is_legacy_partner of this Team.
        :rtype: bool
        """
        return self._is_legacy_partner

    @is_legacy_partner.setter
    def is_legacy_partner(self, is_legacy_partner):
        """
        Sets the is_legacy_partner of this Team.


        :param is_legacy_partner: The is_legacy_partner of this Team.
        :type: bool
        """
    ...
    @property
    def data_source_soaps(self):
        """
        Gets the data_source_soaps of this Team.


        :return: The data_source_soaps of this Team.
        :rtype: list[DataSourceSoap]
        """
        return self._data_source_soaps

    @data_source_soaps.setter
    def data_source_soaps(self, data_source_soaps):
        """
        Sets the data_source_soaps of this Team.


        :param data_source_soaps: The data_source_soaps of this Team.
        :type: list[DataSourceSoap]
        """
