...
class Team(object):
    ...
    """
    def __init__(self, name=None, logo=None, subdomain=None, country=None, created=None, modified=None, id=None, icon=None, client_key=None, java_script_key=None, rest_api_key=None, windows_key=None, master_key=None, status='sandbox', members=None, team_members=None, portals=None, templates=None, brand=None, template_folders=None, workflows=None, images=None, image_folders=None, billing=None, permission=None):
        """
