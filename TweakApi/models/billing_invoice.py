...
class BillingInvoice(object):
    ...
    """
    def __init__(self, id=None, amount_due=None, attempt_count=None, attempted=None, charged=None, closed=None, currency=None, customer=None, date=None, description=None, ending_balance=None, forgiven=None, lines=None, next_payment_attempt=None, paid=None, period_end=None, period_start=None, recipt_number=None, starting_balance=None, statement_descriptor=None, subscription=None, subscription_proration_date=None, subtotal=None, tax=None, total=None):
        """
