...
class DynamicData(object):
    ...
    """
    def __init__(self, name=None, properties_order=None, properties=None, relations=None, validations=None, created=None, modified=None, id=None, team_id=None, team=None):
        """
