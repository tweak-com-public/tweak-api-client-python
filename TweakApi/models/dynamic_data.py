...
class DynamicData(object):
    ...
    """
    def __init__(self, name=None, properties_order=None, properties=None, relations=None, validations=None, created=None, modified=None, record_count=0.0, id=None, team_id=None, team=None):
        """
