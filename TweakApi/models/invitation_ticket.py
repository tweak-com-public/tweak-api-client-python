...
class InvitationTicket(object):
    ...
    """
    def __init__(self, message='', token=None, invitee_email=None, target_model=None, target_id=None, target_attrs=None, status=None, created=None, modified=None, id=None, invitee_id=None, inviter_id=None, target_team_id=None, target_team_member_id=None, target_portal_id=None, target_portal_member_id=None, target_template_id=None, target_template_member_id=None, target_image_folder_id=None, target_image_folder_member_id=None, invitee=None, inviter=None, target_team=None, target_team_member=None, target_portal=None, target_portal_member=None, target_template=None, target_template_member=None, target_image_folder=None, target_image_folder_member=None):
        """
