...
class ProductSizeMaterial(object):
    ...
    """
    def __init__(self, name=None, description=None, thumbnail=None, status=None, binding_type=None, default_bleed=None, created=None, modified=None, id=None, material_id=None, team_id=None, size_id=None, size=None, material=None, team=None):
        """
    ...
    def name(self):
        """
        Gets the name of this ProductSizeMaterial.


        :return: The name of this ProductSizeMaterial.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this ProductSizeMaterial.


        :param name: The name of this ProductSizeMaterial.
        :type: str
        """
