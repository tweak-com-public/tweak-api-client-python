...
class ProductSizeMaterial(object):
    ...
    """
    def __init__(self, code=None, description=None, thumbnail=None, status=None, binding_type=None, default_bleed=None, pdf_color_profile='', created=None, modified=None, id=None, material_id=None, team_id=None, size_id=None, size=None, material=None, team=None):
        """
