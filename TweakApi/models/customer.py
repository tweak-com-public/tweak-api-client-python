...
class Customer(object):
    ...
    """
    def __init__(self, profile_picture=None, first_name=None, last_name=None, initials=None, status=None, created=None, modified=None, realm=None, username=None, email=None, email_verified=None, id=None, designs=None, teams=None, invitation_tickets=None, access_tokens=None, permission=None):
        """
