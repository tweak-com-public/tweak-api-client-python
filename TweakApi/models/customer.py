...
class Customer(object):
    ...
    """
    def __init__(self, profile_picture=None, first_name=None, last_name=None, initials=None, status='active', created=None, modified=None, realm=None, username=None, email=None, email_verified=None, id=None, designs=None, teams=None, invitation_tickets=None, access_tokens=None, permission=None):
        """
    ...
    def designs(self):
        """
        Gets the designs of this Customer.


        :return: The designs of this Customer.
        :rtype: list[Design]
        """
    ...
    def designs(self, designs):
        """
        Sets the designs of this Customer.


        :param designs: The designs of this Customer.
        :type: list[Design]
        """
