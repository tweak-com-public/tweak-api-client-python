...
# **products_count_get**
> InlineResponse200 products_count_get(where=where)
...
> InlineResponse2001 products_id_exists_get(id)
...
# **products_id_head**
> InlineResponse2001 products_id_head(id)
...
> InlineResponse200 products_id_tags_count_get(id, where=where)
...
> InlineResponse2002 products_update_post(where=where, data=data)
