...
[**data_source_rests_update_post**](DataSourceRestApi.md#data_source_rests_update_post) | **POST** /DataSourceRests/update | Update instances of the model matched by {{where}} from the data source.
