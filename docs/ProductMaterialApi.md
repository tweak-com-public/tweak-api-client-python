...
> InlineResponse200 product_materials_count_get(where=where)
...
> InlineResponse2001 product_materials_id_exists_get(id)
...
> InlineResponse2001 product_materials_id_head(id)
...
> InlineResponse2002 product_materials_update_post(where=where, data=data)
