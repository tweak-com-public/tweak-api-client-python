...
> InlineResponse2001 image_folder_members_id_exists_get(id)
...
> InlineResponse2001 image_folder_members_id_head(id)
...
> InlineResponse2002 image_folder_members_update_post(where=where, data=data)
