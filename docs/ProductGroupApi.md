...
> InlineResponse200 product_groups_count_get(where=where)
...
> InlineResponse2001 product_groups_id_exists_get(id)
...
> InlineResponse2001 product_groups_id_head(id)
...
> InlineResponse200 product_groups_id_types_count_get(id, where=where)
...
> InlineResponse2002 product_groups_update_post(where=where, data=data)
