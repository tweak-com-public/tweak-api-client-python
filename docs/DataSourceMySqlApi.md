...
[**data_source_my_sqls_update_post**](DataSourceMySqlApi.md#data_source_my_sqls_update_post) | **POST** /DataSourceMySqls/update | Update instances of the model matched by {{where}} from the data source.
