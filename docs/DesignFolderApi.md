...
> InlineResponse2001 design_folders_id_exists_get(id)
...
> InlineResponse2001 design_folders_id_head(id)
...
> InlineResponse2002 design_folders_update_post(where=where, data=data)
