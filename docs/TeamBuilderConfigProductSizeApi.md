...
> InlineResponse200 team_builder_config_product_sizes_count_get(where=where)
...
> InlineResponse2001 team_builder_config_product_sizes_id_exists_get(id)
...
> InlineResponse2001 team_builder_config_product_sizes_id_head(id)
...
> InlineResponse2002 team_builder_config_product_sizes_update_post(where=where, data=data)
