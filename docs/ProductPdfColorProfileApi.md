...
> InlineResponse200 product_pdf_color_profiles_count_get(where=where)
...
> InlineResponse2001 product_pdf_color_profiles_id_exists_get(id)
...
> InlineResponse2001 product_pdf_color_profiles_id_head(id)
...
> InlineResponse2002 product_pdf_color_profiles_update_post(where=where, data=data)
