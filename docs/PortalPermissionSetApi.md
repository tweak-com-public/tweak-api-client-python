...
[**portal_permission_sets_patch**](PortalPermissionSetApi.md#portal_permission_sets_patch) | **PATCH** /PortalPermissionSets | Patch an existing model instance or insert a new one into the data source.
...
[**portal_permission_sets_put**](PortalPermissionSetApi.md#portal_permission_sets_put) | **PUT** /PortalPermissionSets | Replace an existing model instance or insert a new one into the data source.
[**portal_permission_sets_replace_or_create_post**](PortalPermissionSetApi.md#portal_permission_sets_replace_or_create_post) | **POST** /PortalPermissionSets/replaceOrCreate | Replace an existing model instance or insert a new one into the data source.
[**portal_permission_sets_update_post**](PortalPermissionSetApi.md#portal_permission_sets_update_post) | **POST** /PortalPermissionSets/update | Update instances of the model matched by {{where}} from the data source.
[**portal_permission_sets_upsert_with_where_post**](PortalPermissionSetApi.md#portal_permission_sets_upsert_with_where_post) | **POST** /PortalPermissionSets/upsertWithWhere | Update an existing model instance or insert a new one into the data source based on the where criteria.
...
> InlineResponse200 portal_permission_sets_count_get(where=where)
...
> InlineResponse2001 portal_permission_sets_id_exists_get(id)
...
> InlineResponse2001 portal_permission_sets_id_head(id)
...
# **portal_permission_sets_patch**
> PortalPermissionSet portal_permission_sets_patch(data=data)
...
try: 
    # Patch an existing model instance or insert a new one into the data source.
    api_response = api_instance.portal_permission_sets_patch(data=data)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PortalPermissionSetApi->portal_permission_sets_patch: %s\n" % e)
```
...
# **portal_permission_sets_put**
> PortalPermissionSet portal_permission_sets_put(data=data)
...
try: 
    # Replace an existing model instance or insert a new one into the data source.
    api_response = api_instance.portal_permission_sets_put(data=data)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PortalPermissionSetApi->portal_permission_sets_put: %s\n" % e)
```
...
# **portal_permission_sets_replace_or_create_post**
> PortalPermissionSet portal_permission_sets_replace_or_create_post(data=data)
...
try: 
    # Replace an existing model instance or insert a new one into the data source.
    api_response = api_instance.portal_permission_sets_replace_or_create_post(data=data)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PortalPermissionSetApi->portal_permission_sets_replace_or_create_post: %s\n" % e)
```
...
# **portal_permission_sets_update_post**
> InlineResponse2002 portal_permission_sets_update_post(where=where, data=data)
...
try: 
    # Update instances of the model matched by {{where}} from the data source.
    api_response = api_instance.portal_permission_sets_update_post(where=where, data=data)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PortalPermissionSetApi->portal_permission_sets_update_post: %s\n" % e)
```
...
# **portal_permission_sets_upsert_with_where_post**
> PortalPermissionSet portal_permission_sets_upsert_with_where_post(where=where, data=data)
...
try: 
    # Update an existing model instance or insert a new one into the data source based on the where criteria.
    api_response = api_instance.portal_permission_sets_upsert_with_where_post(where=where, data=data)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PortalPermissionSetApi->portal_permission_sets_upsert_with_where_post: %s\n" % e)
```
