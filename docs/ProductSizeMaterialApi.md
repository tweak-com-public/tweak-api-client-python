...
> InlineResponse2001 product_size_materials_count_get(where=where)
...
> InlineResponse2002 product_size_materials_id_exists_get(id)
...
> InlineResponse2002 product_size_materials_id_head(id)
...
> InlineResponse2003 product_size_materials_update_post(where=where, data=data)
