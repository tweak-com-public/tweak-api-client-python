...
> InlineResponse2001 portal_templates_id_exists_get(id)
...
> InlineResponse2001 portal_templates_id_head(id)
...
> InlineResponse2002 portal_templates_update_post(where=where, data=data)
