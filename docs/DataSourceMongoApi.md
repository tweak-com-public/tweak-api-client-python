...
[**data_source_mongos_update_post**](DataSourceMongoApi.md#data_source_mongos_update_post) | **POST** /DataSourceMongos/update | Update instances of the model matched by {{where}} from the data source.
