...
> InlineResponse2001 template_tags_id_exists_get(id)
...
> InlineResponse2001 template_tags_id_head(id)
...
> InlineResponse2002 template_tags_update_post(where=where, data=data)
